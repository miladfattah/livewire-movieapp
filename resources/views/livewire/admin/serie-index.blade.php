	...
	<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                <div class="p-1 flex items-center">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        <input wire:model="serieTmdbId"  id="tmdb_id_g" name="tmdb_id_g"
                            class="px-3 py-2 border border-gray-300 rounded" placeholder="Serie ID" />
                    </div>
                </div>
                <div class="p-1">
                    <button type="button" wire:click="generateSerires"
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" wire:key="key-{{$serie->id}}-index">
                    <td class="px-6 py-4">
                        {{$serie->name}}
                    </td>
                    <td class="px-6 py-4">
                        ...
                        <div class="m-7">
                            <form>
                                ...
                                <div class="mb-6">
                                    ...
                                    <button wire:click="updateSerie" type="button" class="px-3 py-2 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
